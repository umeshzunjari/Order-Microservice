...
public class OrderService {
	...
	public OrderDetailsDTO getOrder(Integer buyerid) {
		return OrderDetailsDTO.valueOf(orderrepo.getOne(buyerid));
	}
	...
	/*
	 * public void placetheOrder(CartDTO cart) { ProductsOrderedDTO
	 * productsorder=new ProductsOrderedDTO();
	 * productsorder.setProdid(cart.getProdid()); ProductsOrdered order=
	 * productsorder.createEntity(); productrepo.save(order); }
	 */
